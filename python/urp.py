...
if __name__ == '__main__':
    ...
    data_path = '/RTBidding/make-ipinyou-data-master/'
    train_path = data_path + camp + "/train.yzx.txt"
    test_path = data_path + camp + "/test.yzx.txt"
    ...
    if "LR" in algo:
        batch_size = 10000
        buf_size = 1000000
        model = LR([X_dim, X_field], batch_size, None
